...
# ==================== НАСТРОЙКИ БОТА ====================
TOKEN = '8492718356:AAHj8WywqZF7CVjDWYbV8BpGqA2bdj4L6ZY'
...
BACKPACKS = {
    'рюкзак1': {
        ...
        'rc_bonus': 1.20,      # +20% RC
        'rf_bonus': 1.10,      # +10% RF
        'max_medkits': 1        # 1 аптечка в рюкзак
    },
    'рюкзак2': {
        ...
        'rc_bonus': 1.30,      # +30% RC
        'rf_bonus': 1.15,      # +15% RF
        'max_medkits': 2        # 2 аптечки в рюкзак
    },
    'рюкзак3': {
        ...
        'rc_bonus': 1.45,      # +45% RC
        'rf_bonus': 1.18,      # +18% RF
        'max_medkits': 3        # 3 аптечки в рюкзак
    }
}

# ==================== СТАРЫЕ ЛИМИТЫ ТОВАРОВ ====================
SHOP_LIMITS = {
    'броня3': 10,
    'броня4': 7,
    'броня5': 5,
...
# ==================== МЕТАЛЛОИСКАТЕЛЬ ====================
METAL_DETECTOR_PRICE = 10000
METAL_DETECTOR_LEVEL = 5
METAL_DETECTOR_CHANCE = 10  # 10% шанс найти сундук
...
def get_backpack_bonus(backpack_level):
    """Получить бонусы рюкзака по его уровню"""
    return BACKPACKS.get(backpack_level, BACKPACKS['рюкзак1'])
